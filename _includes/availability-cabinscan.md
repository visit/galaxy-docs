###TO BE ADDED TO AVAILABILITY WHEN CABIN SCAN WORKS### ###ACCOMMODATION GET DOES NOT WORK### ###GEONODES DON'T HAVE NAMES###
...
`POST https://galaxy.test.citybreak.com/api/availability/cabin/scan`
