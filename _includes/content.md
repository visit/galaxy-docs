...
<aside class="notice">
If using the Visit Test Organisation API Key you can use 17692 as the `pointOfSalesId`.  
<br><br>
Content endpoints are cached for 30 minutes by ApiKey and Accept-Language; **identical** requests return the cached response.
</aside>
