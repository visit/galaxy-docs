...
--header 'apiKey: APIKEY132456789EWOK' -d '{
 ...
 }' 'https://galaxy.citybreak.com/v3/api/availability/get'
```

```javascript
var r = fetch("https://galaxy.citybreak.com/v3/api/availability/get",
{
	method: "POST",
	headers: {
	   "ApiKey:" "APIKEY132456789EWOK",
